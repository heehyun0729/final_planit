...
<body>
	...
	<label for="terms_agree">사이트 이용약관에 동의합니다.</label>
	...
	<label for="personal_information_terms_agree">개인정보 처리방침에 동의합니다.</label>
	<input type="checkbox" id="personal_information_terms_agree">
