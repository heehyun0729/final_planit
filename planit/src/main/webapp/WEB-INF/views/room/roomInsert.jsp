			...
			<div class="col mt-5 d-flex justify-content-center">
				<div class="text-left">
					...
					<form method="post" id="form10"
						action="<c:url value='/roomInsert'/>"
						enctype="multipart/form-data">
						<input type="hidden" name="accom_num" value="${param.accom_num}"><br />
						방타입<br /> <input type="text" name="room_type"><br /> 
						가격<br />
						<input type="text" name="room_price">원<br /> 
						방설명<br />
						<textarea rows="5" cols="50" name="room_comm"></textarea>
						<br /> 
						방인원<br /> <input type="text" name="room_capa">명<br />
						방이미지<br /> <input type="file" name="file1" class="genric-btn info circle"><br />
