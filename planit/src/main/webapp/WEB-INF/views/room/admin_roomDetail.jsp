			...
			<div class="col mt-5 d-flex justify-content-center">
				<div class="text-left">
					...
					<table class="table">
						...
						<tr>
							<th>방수정</th>
							<td><a href="${pageContext.request.contextPath }/adminRoomUpdate?accom_num=${accom_num}&room_num=${vo.room_num }"><i
									class="fas fa-tools" style="color: #339af0;"></i></a>
						</tr>
						<tr>
							<th>방삭제</th>
							<td><a href="${pageContext.request.contextPath }/admin/roomDelete?accom_num=${accom_num}&room_num=${vo.room_num }"><i
									class="fas fa-trash" style="color: #339af0;"></i></a></td>
						</tr>
					</table>
					<a href="<c:url value='/admin/roomList?accom_num=${vo.accom_num }'/>"class="genric-btn info circle">방정보</a>
				</div>
			</div>
		</div>
	</div>
