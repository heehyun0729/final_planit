		...
		<div class="row ">
			<div class="col mt-5 d-flex justify-content-center">
				<div class="text-center">
						...
						<c:forEach var="vo" items="${list }">
							<tr>
								...
								<td><a style="color: #339af0;"
									href="${pageContext.request.contextPath }/accomDetail?accom_num=${vo.accom_num}">${vo.accom_name }</a></td>
							</tr>
						</c:forEach>
					</table>
					<div>
							...
							<ul class="pagination">
								<li class="page-item"><c:choose>
										<c:when test="${pu.startPageNum  > 5 }">
											<a
												href="${pageContext.request.contextPath }/accommList?pageNum=${pu.startPageNum - 1}&field=${field}&keyword=${keyword}&sell_num=${sell_num}"
								...
								<li class="page-item"><c:choose>
										<c:when test="${pu.endPageNum < pu.totalPageCount}">
											<a
												href="${pageContext.request.contextPath }/accommList?pageNum=${pu.endPageNum + 1}&field=${field}&keyword=${keyword}&sell_num=${sell_num}"
					...
					<br />
					<br /> <a href="${pageContext.request.contextPath }/adminHome"
