				...
				<br/><br/>
					<table class="table">
						...
						<tr>
							<th>숙소수정</th>
							<td><a
								href="${pageContext.request.contextPath }/adminAccomUpdate?accom_num=${vo.accom_num}"><i
									class="fas fa-tools" style="color: #339af0;"></i></a>
						</tr>
						<tr>
							<th>숙소삭제</th>
							<td><a
								href="${pageContext.request.contextPath }/admin/accomDelete?accom_num=${vo.accom_num}"><i
									class="fas fa-trash" style="color: #339af0;"></i></a></td>
						</tr>
						<tr>
							<th>방정보</th>
							<td><a
								href="<c:url value='/admin/roomList?accom_num=${vo.accom_num }'/>"><i
