	...
	<div class="container">
		<div class="row ">
			<div class="col mt-5 d-flex justify-content-center">
				<div class="text-left">
					<h1>숙소수정</h1>
					<form method="post" id="form5" action="adminAccomUpdate"
						...
						판매자번호<br /> <input type="text" name="sell_num"
							value="${vo.sell_num }" disabled="disabled"><br /> 숙소명<br />
						<input type="text" name="accom_name" value="${vo.accom_name }"><br />
						숙소주소<br />
						...
						<br /> 국가<br /> <input type="text" name="accom_country"
							value="${vo.accom_country }" disabled="disabled"><br />
						도시<br /> <input type="text" name="accom_city"
							value="${vo.accom_city }" disabled="disabled"><br /> 파일명<br />
						<input type="text" name="accom_city"
							value="${vo.accommImg_orgImg }" disabled="disabled"><br />
						수정할파일<br /> <input type="file" name="file1"
							class="genric-btn info circle"><br /> <br /> <a
