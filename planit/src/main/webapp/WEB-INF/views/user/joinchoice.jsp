...
<body>
	...
	<form method="post" action="<c:url value=''/>">
		<!-- 이용약관 -->
		<div id="terms" style="overflow: scroll; width: 90%; height: 300px; padding: 10px;">
			<div class="terms_title">이용약관</div>
			<div class="terms_title">제 1 장 총 칙</div>
			<div class="terms_title_title">제 1 조 (목적)</div>
			...
			<div class="terms_title">제 2 장 서비스 이용계약</div>
			<div class="terms_title_title">제 4 조 (이용계약의 성립)</div>
			<div class="terms_content">
				① 이용약관 하단의 동의 버튼을 누르면 이 약관에 동의하는 것으로 간주됩니다.
				<br>
				② 이용계약은 서비스 이용희망자의 이용약관 동의 후 이용 신청에 대하여 사이트가 승낙함으로써 성립합니다.
			</div>
			<div class="terms_title_title">제 5 조 (이용신청)</div>
			<div class="terms_content">
			...
			<div class="terms_title_title">제 6 조 (이용신청의 승낙)</div>
			<div class="terms_content">
			...
			<div class="terms_title_title">제 7 조 (이용자정보의 변경)</div>
			<div class="terms_content">회원은 이용 신청시에 기재했던 회원정보가 변경되었을 경우에는, 온라인으로 수정하여야 하며 변경하지 않음으로 인하여 발생되는 모든 문제의 책임은 회원에게 있습니다.</div>
			<div class="terms_title">제 3 장 계약 당사자의 의무</div>
			<div class="terms_title_title">제 8 조 (사이트의 의무)</div>
			<div class="terms_content">
			...
			<div class="terms_title_title">제 9 조 (회원의 의무)</div>
			<div class="terms_content">
			...
			<div class="terms_title">제 4 장 서비스 제공 및 이용</div>
			<div class="terms_title_title">제 10 조 (회원 아이디(ID)와 비밀번호 관리에 대한 회원의 의무)</div>
			<div class="terms_content">
			...
			<div class="terms_title_title">제 11 조 (서비스 제한 및 정지)</div>
			<div class="terms_content">
			...
			<div class="terms_title">제5장 계약사항의 변경, 해지</div>
			<div class="terms_title_title">제 12 조 (정보의 변경)</div>
			<div class="terms_content">회원이 주소, 비밀번호 등 고객정보를 변경하고자 하는 경우에는 홈페이지의 회원정보 변경 서비스를 이용하여 변경할 수 있습니다.</div>
			<div class="terms_title_title">제 13 조 (계약사항의 해지)</div>
			<div class="terms_content">
			...
			<div class="terms_title">제6장 손해배상</div>
			<div class="terms_title_title">제 14 조 (면책조항)</div>
			<div class="terms_content">
			...
			<div class="terms_title_title">제 15 조 (관할법원)</div>
		...
		<label for="terms_agree">사이트 이용약관에 동의합니다.</label> <input type="checkbox" id="terms_agree" name="terms_agree">

		<!-- 개인정보처리방침 -->
		<div id="personal_information_terms" style="overflow: scroll; width: 90%; height: 300px; padding: 10px;">
			<div class="personal_information_terms_title">개인정보 처리방침</div>

			<div class="personal_information_terms_title">Planit(이하 플랜잇)은 개인정보 보호법 제30조에 따라 정보주체(고객)의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립․공개합니다.</div>

			<div class="personal_information_terms_title">1. 개인정보의 처리목적</div>
			<div class="personal_information_terms_content">
				플랜잇은 다음의 목적을 위하여 개인정보를 처리하고 있으며, 다음의 목적 이외의 용도로는 이용하지 않습니다.
				<br>
				- 고객 가입의사 확인, 고객에 대한 서비스 제공에 따른 본인 식별․인증, 회원자격 유지․관리, 물품 또는 서비스 공급에 따른 금액 결제, 물품 또는 서비스의 공급․배송 등
			</div>

			<div class="personal_information_terms_title">2. 개인정보의 처리 및 보유기간</div>
			<div class="personal_information_terms_content">
			...
			<div class="personal_information_terms_title">3. 개인정보의 제3자 제공</div>
			<div class="personal_information_terms_content">플랜잇은 정보주체의 별도 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조에 해당하는 경우 외에는 개인정보를 제3자에게 제공하지 않습니다.</div>

			<div class="personal_information_terms_title">4. 개인정보처리의 위탁</div>
			<div class="personal_information_terms_content">
			...
			<div class="personal_information_terms_title">5. 정보주체와 법정대리인의 권리․의무 및 행사방법</div>
			<div class="personal_information_terms_content">
			...
			<div class="personal_information_terms_title">6. 처리하는 개인정보 항목</div>
			<div class="personal_information_terms_content">
			...
			<div class="personal_information_terms_title">7. 개인정보의 파기</div>
			<div class="personal_information_terms_content">
			...
			<div class="personal_information_terms_title">8. 개인정보의 안전성 확보조치</div>
			<div class="personal_information_terms_content">
			...
			<div class="personal_information_terms_title">9. 개인정보 자동 수집 장치의 설치∙운영 및 거부에 관한 사항</div>
			<div class="personal_information_terms_content">
			...
			<div class="personal_information_terms_title">10. 개인정보 보호책임자</div>
			<div class="personal_information_terms_content">
			...
			<div class="personal_information_terms_title">11. 개인정보 처리방침 변경 이 개인정보 처리방침은 2019. 06. 23.부터 적용됩니다.</div>
		</div>
		<label for="personal_information_terms_agree">개인정보 처리방침에 동의합니다.</label> <input type="checkbox" id="personal_information_terms_agree" name="personal_information_terms_agree">
	</form>

	<div id="plzcheckMsg"></div>
	<ul>
		...
		<li><a class="joinhref" href="">이메일로 회원가입(판매자)(미구현)</a></li>
	</ul>
</body>
</html>