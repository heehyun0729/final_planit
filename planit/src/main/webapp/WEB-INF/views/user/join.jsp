...
<body>
	...
	<form method="post" action="<c:url value='nomaljoin'/>" id="joinForm">
		...
		<label for="mem_id">*아이디</label> <input type="text" id="mem_id" name="mem_id" placeholder="5~14 사이의 소문자 영문과 숫자 조합" value="${vo.mem_id }"><input type="button" id="idcheck" name="idcheck" value="중복검사" disabled="disabled"> <span id="idcheckresult"></span>
		<br>
		<label for="mem_pwd">*비밀번호</label> <input type="password" id="mem_pwd" name="mem_pwd" placeholder="10~20 사이의 특수문자를 포함한 영문(대소문자 구분)과 숫자 조합"><span id="pwdresult"></span>
		<br>
		...
		<br>
		<label for="mem_nickname">*닉네임</label> <input type="text" id="mem_nickname" name="mem_nickname" value="${vo.mem_nickname }" placeholder="3~10자리 한글,영문,숫자"><input type="button" id="nickcheck" name="nickcheck" value="중복검사" disabled="disabled"><span id="nickckresult"></span>
		<br>
