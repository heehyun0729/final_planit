...
<body>
	...
	<form method="post" action="<c:url value='nomaljoin'/>">
		<label for="mem_id">*아이디(5~14 사이의 소문자 영문과 숫자 조합)</label> <input type="text" id="mem_id" name="mem_id" placeholder="planit01" value="${vo.mem_id }"><input type="button" id="idcheck" name="idcheck" value="중복검사" disabled="disabled"> <span id="idcheckresult"></span>
		<br>
