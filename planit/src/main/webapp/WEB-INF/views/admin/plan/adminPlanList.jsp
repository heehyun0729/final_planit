		...
		<div class="modal-dialog modal-xl" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="container">
						<div class="row d-flex" style = "margin-bottom: 30px;">
							<div class = "col-lg-4 p-2">
								<img id = "planImg" class = "img-thumbnail" style = "width: 200px;height: 200px;">
							</div>
						...
						<div class = "row">
							<h5>일정표</h5>
							<table class="table text-center" id = "planDetailTbl">
							</table>
						</div>
					</div>
				</div>
