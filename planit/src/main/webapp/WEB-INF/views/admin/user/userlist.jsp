			...
			<div class="row ">
				<div class="col mt-5 text-center">
					<ul class="nav nav-pills">
						<li class="nav-item"><a class="nav-link ${current =='approvedAdList' ? 'active': ''}" href="<c:url value='/admin/user/userlist'/>" class="ui-tabs-anchor">회원목록</a></li>
						<li class="nav-item"><a class="nav-link ${current =='requestRefundAdList' ? 'active': ''}" href="<c:url value='/admin/user/userList'/>" class="ui-tabs-anchor">회원 정지/탈퇴목록</a></li>
					</ul>
					<table class="table table-hover ">
						<thead>
						<tr>
							<th scope="col">아이디</th><th scope="col">닉네임</th><th scope="col">이메일</th><th scope="col">성별</th><th scope="col">생년</th><th scope="col">회원상태</th><th scope="col">API</th>
						</tr>
						</thead>
						<tbody>
						<c:choose>
