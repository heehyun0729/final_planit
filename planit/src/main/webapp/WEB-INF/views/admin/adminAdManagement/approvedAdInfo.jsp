...
<section>
	<article>
		...
		<div class="tableDiv">
			<div class="form-box3">
				<a id="approveBtn" class="btn" href="<c:url value='/admin/adminAdManagement/approvedAdInfoApprove?ad_num=${getAdInfo.ad_num }'/>">게재 승인</a><a id="declineBtn" class="btn" href="#">게재 반려</a>
