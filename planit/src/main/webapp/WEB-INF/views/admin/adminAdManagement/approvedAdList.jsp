			...
			<div class="tableContentDiv">
				<div class="ui-tabs ui-corner-all ui-widget ui-widget-content">
					<ul class="ui-tabs-nav ui-corner-all ui-helper-reset ui-helper-clearfix ui-widget-header">
						<li class="ui-tabs-tab ui-corner-top ui-state-default ui-tab ui-tabs-active ui-state-active"><a href="<c:url value='/admin/adminAdManagement/approvedAdList'/>" class="ui-tabs-anchor">게재신청</a></li>
					...
					<form id="form" method="post" action="<c:url value='/admin/adminAdManagement/approvedAdList'/>">
						<select name="field">
