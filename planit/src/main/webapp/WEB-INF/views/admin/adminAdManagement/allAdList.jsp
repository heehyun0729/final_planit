					...
					<div class="d-flex justify-content-center">
						<ul class="pagination">
							<c:if test="${map.startPageNum!=1 }">
								<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath }/admin/adminAdManagement/allAdList?pageNum=${map.startPageNum-1}&field=${param.field}&keyword=${param.keyword}&progress=${map.ad_progress}">◀</a></li>
							</c:if>
							...
							<c:if test="${map.totalPageCount!=map.endPageNum }">
								<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath }/admin/adminAdManagement/allAdList?pageNum=${map.endPageNum+1}&field=${param.field}&keyword=${param.keyword}&progress=${map.ad_progress}">▶</a></li>
							</c:if>
						</ul>
					</div>
