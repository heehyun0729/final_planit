...
public class RoomImageVo {
	...
	private int roomImageChk;
	public RoomImageVo() {}
	public RoomImageVo(int roomImg_num, int room_num, String roomImg_orgImg, String roomImg_saveImg, int roomImageChk) {
		super();
		this.roomImg_num = roomImg_num;
		this.room_num = room_num;
		this.roomImg_orgImg = roomImg_orgImg;
		this.roomImg_saveImg = roomImg_saveImg;
		this.roomImageChk = roomImageChk;
	}
	...
	public int getRoomImageChk() {
		return roomImageChk;
	}
	public void setRoomImageChk(int roomImageChk) {
		this.roomImageChk = roomImageChk;
	}
