...
public class ReviewVo {
	...
	public ReviewVo(int review_num, String mem_id, String review_country, String review_city, String review_title,
			String review_content, Date review_date, int review_hit, int review_like, int review_Chk) {
		super();
	...
	public String toString() {
		return "ReviewVo [review_num=" + review_num + ", mem_id=" + mem_id + ", review_country=" + review_country
				...
				+ review_content + ", review_date=" + review_date + ", review_hit=" + review_hit + ", review_like="
				+ review_like + ", review_Chk=" + review_Chk + "]";
	}
}
